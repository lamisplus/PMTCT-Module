...
const ClinicVisit = (props) => {
  ...
  async function ClinicVisitListHistory() {
    ...
    axios
      ...
      .then((response) => {
        setLoading(false);
        setClinicVisitList(
          response.data.filter((x) => x.isCommencement !== true)
        );
      })
      .catch((error) => {
        setLoading(false);
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      axios
        .put(`${baseUrl}hiv/art/clinic-visit/${visitId}`, objValues, {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then((response) => {
          setSaving(false);
            ...
            <div className="card-body">
              ...
              >
                {clinicVisitList.map((visit, index) => (
                  <div
                    className="media pb-3 border-bottom mb-0 align-items-center"
                    key={index}
                  >
                ...
                <Grid.Column>
                  <Segment>
                    ...
                    >
                      <h4 style={{ color: "#fff" }}>
                        {" "}
                        Visit Date - {vital.encounterDate}
                      </h4>
                    </Label>
                    <div className="row">
